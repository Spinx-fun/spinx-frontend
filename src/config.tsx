...
export const API_URL = "https://api.valhalla.fun/";
...
export const RPC_URL =
  ...
  "https://devnet.helius-rpc.com/?api-key=b9dfa3e6-fc56-4de1-ba97-a1646312f3da"
export const SOL_PRICE_API =
  "https://api.coingecko.com/api/v3/simple/price?ids=solana&vs_currencies=usd";

export const JUPITER_API = 'https://lite-api.jup.ag/price/v3?ids='
