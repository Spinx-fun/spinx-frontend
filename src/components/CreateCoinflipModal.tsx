...
export default function CreateCoinflipModal(props: {
    ...
    return (
        <div
            className="fixed left-0 top-0 w-full h-[100vh] z-[40] backdrop-blur-sm flex-col bg-[#00000050] grid place-content-center"
        >
            <div className="flex flex-col md:m-6 bg-[#17161B] w-[calc(100vw-30px)] md:w-[600px] lg:w-[774px] rounded-[5px]">
                <div className="flex flex-row items-center justify-between py-4 px-6 border-b border-[#ffffff10]">
                    <span className="text-[12px] text-[#8B8A8D] font-[500]">Create Coinflip</span>
                ...
                <div className='flex flex-col sm:flex-row justify-between border-b border-[#ffffff10] '>
                    ...
                    <div className="px-6 pt-6 pb-12 sm:py-12 flex flex-col gap-2 w-full sm:w-2/3">
                ...
                <div className="flex justify-end p-6 gap-4">
                    <button onClick={() => setBetNumber(1)}>
                        <img src='/img/head.png' className={`w-[44px] h-[44px] ${betNumber === 1 ? '' : 'opacity-25'}`} />
                    </button>
                    <button onClick={() => setBetNumber(0)}>
                        <img src='/img/tail.png' className={`w-[44px] h-[44px] ${betNumber === 0 ? '' : 'opacity-25'}`} />
                    </button>
                    {wallet.publicKey ? (
                        <button
                            className="bg-[#F7B831] hover:opacity-90 text-[#17161B] text-[12px] font-[500] px-5 py-2 rounded-[4px]"
                            onClick={handleBet}
                        ...
                        <div className="bg-[#F7B831] hover:opacity-90 text-[#17161B] text-[12px] font-[500] rounded-[4px] py-1">
                            <WalletMultiButton />
                        </div>
                    )}
                </div>
